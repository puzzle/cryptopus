...
describe ItemsController do
  ...
  context 'POST create' do
    ...
    it 'does not upload file with empty file as conf_admin' do
      account1 = accounts(:account1)
    ...
    it 'does not upload file with empty file as admin' do
      account1 = accounts(:account1)
    ...
    it 'doesnt upload if no file and no item  params exist as admin' do
      login_as(:admin)
      item_params = {}
