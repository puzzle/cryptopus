...
for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n])}return e},o="undefined"==typeof global?self:global,s=function(e,r){if(Array.isArray(e))return e
...
return this&&this!==V?ee(O(this),e,r):new V.NumberFormat(e,r)}function ee(e,r,t){var n=E(e),a=k()
...
n["[[style]]"]=m
var v,d=W(t,"currency","string")
if(void 0!==d&&(v=R(String(d)),!1===G.test(v)))throw new RangeError("'"+d+"' is not a valid currency code")
if("currency"===m&&void 0===d)throw new TypeError("Currency code is required when style is currency")
var h=void 0
"currency"===m&&(d=d.toUpperCase(),n["[[currency]]"]=d,h=function(e){return void 0!==J[e]?J[e]:2}(d))
var p=W(t,"currencyDisplay","string",new D("code","symbol","name"),"symbol")
"currency"===m&&(n["[[currencyDisplay]]"]=p)
var y=X(t,"minimumIntegerDigits",1,21,1)
n["[[minimumIntegerDigits]]"]=y
var b=X(t,"minimumFractionDigits",0,20,"currency"===m?h:0)
n["[[minimumFractionDigits]]"]=b
var w=X(t,"maximumFractionDigits",b,20,"currency"===m?Math.max(b,h):"percent"===m?Math.max(b,0):Math.max(b,3))
n["[[maximumFractionDigits]]"]=w
var F=t.minimumSignificantDigits,S=t.maximumSignificantDigits
void 0===F&&void 0===S||(F=X(t,"minimumSignificantDigits",1,21,1),S=X(t,"maximumSignificantDigits",F,21,21),n["[[minimumSignificantDigits]]"]=F,n["[[maximumSignificantDigits]]"]=S)
var L=W(t,"useGrouping","boolean",void 0,!0)
n["[[useGrouping]]"]=L
var P=l[g].patterns[m]
return n["[[positivePattern]]"]=P.positivePattern,n["[[negativePattern]]"]=P.negativePattern,n["[[boundFormat]]"]=void 0,n["[[initializedNumberFormat]]"]=!0,u&&(e.format=re.call(e)),a(),e}function re(){var e=null!==this&&"object"===l.typeof(this)&&E(this)
if(!e||!e["[[initializedNumberFormat]]"])throw new TypeError("`this` value for format() is not an initialized Intl.NumberFormat object.")
if(void 0===e["[[boundFormat]]"]){var r=w.call((function(e){return ae(this,Number(e))}),this)
e["[[boundFormat]]"]=r}return e["[[boundFormat]]"]}function te(e,r){for(var t=ne(e,r),n=[],a=0,i=0;t.length>i;i++){var o=t[i],s={}
s.type=o["[[type]]"],s.value=o["[[value]]"],n[a]=s,a+=1}return n}function ne(e,r){var t=E(e),n=t["[[dataLocale]]"],a=t["[[numberingSystem]]"],i=x.NumberFormat["[[localeData]]"][n],o=i.symbols[a]||i.symbols.latn,s=void 0
...
var y=void 0
y=g.call(t,"[[minimumSignificantDigits]]")&&g.call(t,"[[maximumSignificantDigits]]")?ie(r,t["[[minimumSignificantDigits]]"],t["[[maximumSignificantDigits]]"]):oe(r,t["[[minimumIntegerDigits]]"],t["[[minimumFractionDigits]]"],t["[[maximumFractionDigits]]"]),se[a]?function(){var e=se[a]
...
p.call(l,{"[[type]]":"literal","[[value]]":Z})}return l}function ae(e,r){for(var t=ne(e,r),n="",a=0;t.length>a;a++){n+=t[a]["[[value]]"]}return n}function ie(e,r,t){var n=t,a=void 0,i=void 0
...
"."===a.charAt(a.length-1)&&(a=a.slice(0,-1))}return a}function oe(e,r,t,n){var a,i=n,o=Math.pow(10,i)*e,s=0===o?"0":o.toFixed(0),l=(a=s.indexOf("e"))>-1?s.slice(a+1):0
...
return r(),H(n,a,t)}),x.NumberFormat)}),f(V.NumberFormat.prototype,"format",{configurable:!0,get:re}),Object.defineProperty(V.NumberFormat.prototype,"formatToParts",{configurable:!0,enumerable:!1,writable:!0,value:function(){var e=arguments.length<=0||void 0===arguments[0]?void 0:arguments[0],r=null!==this&&"object"===l.typeof(this)&&E(this)
...
return v({},r)}})
var le=/(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g,ce=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,ue=/[rqQASjJgwWIQq]/,ge=["era","year","month","day","weekday","quarter"],fe=["hour","minute","second","hour12","timeZoneName"]
function me(e){for(var r=0;r<fe.length;r+=1)if(e.hasOwnProperty(fe[r]))return!1
return!0}function ve(e){for(var r=0;r<ge.length;r+=1)if(e.hasOwnProperty(ge[r]))return!1
return!0}function de(e,r){for(var t={_:{}},n=0;n<ge.length;n+=1)e[ge[n]]&&(t[ge[n]]=e[ge[n]]),e._[ge[n]]&&(t._[ge[n]]=e._[ge[n]])
for(var a=0;a<fe.length;a+=1)r[fe[a]]&&(t[fe[a]]=r[fe[a]]),r._[fe[a]]&&(t._[fe[a]]=r._[fe[a]])
return t}function he(e){return e.pattern12=e.extendedPattern.replace(/'([^']*)'/g,(function(e,r){return r||"'"})),e.pattern=e.pattern12.replace("{ampm}","").replace(ce,""),e}function pe(e,r){switch(e.charAt(0)){case"G":return r.era=["short","short","short","long","narrow"][e.length-1],"{era}"
...
case"z":case"Z":case"O":case"v":case"V":case"X":case"x":return r.timeZoneName=e.length<4?"short":"long","{timeZoneName}"}}function ye(e,r){if(!ue.test(r)){var t={originalPattern:r,_:{}}
return t.extendedPattern=r.replace(le,(function(e){return pe(e,t._)})),e.replace(le,(function(e){return pe(e,t)})),he(t)}}var be={second:{numeric:"s","2-digit":"ss"},minute:{numeric:"m","2-digit":"mm"},year:{numeric:"y","2-digit":"yy"},day:{numeric:"d","2-digit":"dd"},month:{numeric:"L","2-digit":"LL",narrow:"LLLLL",short:"LLL",long:"LLLL"},weekday:{narrow:"ccccc",short:"ccc",long:"cccc"}}
var we=v(null,{narrow:{},short:{},long:{}})
function xe(e,r,t,n,a){var i=e[r]&&e[r][t]?e[r][t]:e.gregory[t],o={narrow:["short","long"],short:["long","narrow"],long:["short","narrow"]},s=g.call(i,n)?i[n]:g.call(i,o[n][0])?i[o[n][0]]:i[o[n][1]]
return null!==a?s[a]:s}function je(){var e=arguments[0],r=arguments[1]
return this&&this!==V?ze(O(this),e,r):new V.DateTimeFormat(e,r)}function ze(e,r,t){var n=E(e),i=k()
if(!0===n["[[initializedIntlObject]]"])throw new TypeError("`this` object has already been initialized as an Intl object")
f(e,"__getInternalProperties",{value:function(){if(arguments[0]===j)return n}}),n["[[initializedIntlObject]]"]=!0
var o=B(r)
t=ke(t,"any","date")
...
for(var y in n["[[timeZone]]"]=p,s=new z,De)if(g.call(De,y)){var b=W(t,y,"string",De[y])
...
for(i in r)r.hasOwnProperty(i)&&(s=ye(i,o=r[i]))&&(a.push(s),me(s)?g.push(s):ve(s)&&u.push(s))
for(i in t)t.hasOwnProperty(i)&&(s=ye(i,o=t[i]))&&(a.push(s),u.push(s))
for(i in n)n.hasOwnProperty(i)&&(s=ye(i,o=n[i]))&&(a.push(s),g.push(s))
for(l=0;l<u.length;l+=1)for(c=0;c<g.length;c+=1)o="long"===g[c].month?g[c].weekday?e.full:e.long:"short"===g[c].month?e.medium:e.short,(s=de(g[c],u[l])).originalPattern=o,s.extendedPattern=o.replace("{0}",u[l].extendedPattern).replace("{1}",g[c].extendedPattern).replace(/^[,\s]+|[,\s]+$/gi,""),a.push(he(s))
...
for(var l in De)if(g.call(De,l)){var c=e["[["+l+"]]"],u=g.call(o,l)?o[l]:void 0
...
for(var n in De)g.call(De,n)&&void 0!==e["[["+n+"]]"]&&t.push(n)
if(1===t.length){var i=function(e,r){var t
if(be[e]&&be[e][r])return t={originalPattern:be[e][r],_:a({},e,r),extendedPattern:"{"+e+"}"},a(t,e,r),a(t,"pattern12","{"+e+"}"),a(t,"pattern","{"+e+"}"),t}(t[0],e["[["+t[0]+"]]"])
if(i)return i}var o=-1/0,s=void 0,l=0,c=r.length
for(;l<c;){var u=r[l],f=0
for(var v in De)if(g.call(De,v)){var d=e["[["+v+"]]"],h=g.call(u,v)?u[v]:void 0,p=g.call(u._,v)?u._[v]:void 0
...
w<=1&&b>=2||w>=2&&b<=1?x>0?f-=6:x<0&&(f-=8):x>1?f-=3:x<-1&&(f-=6)}}u._.hour12!==e.hour12&&(f-=1),f>o&&(o=f,s=u),l++}return s}(s,F)}for(var L in De)if(g.call(De,L)&&g.call(w,L)){var P=w[L]
...
return n["[[pattern]]"]=N,n["[[boundFormat]]"]=void 0,n["[[initializedDateTimeFormat]]"]=!0,u&&(e.format=Oe.call(e)),i(),e}f(V,"DateTimeFormat",{configurable:!0,writable:!0,value:je}),f(je,"prototype",{writable:!1})
var De={weekday:["narrow","short","long"],era:["narrow","short","long"],year:["2-digit","numeric"],month:["2-digit","numeric","narrow","short","long"],day:["2-digit","numeric"],hour:["2-digit","numeric"],minute:["2-digit","numeric"],second:["2-digit","numeric"],timeZoneName:["short","long"]}
function ke(e,r,t){if(void 0===e)e=null
else{var n=O(e)
for(var a in e=new z,n)e[a]=n[a]}e=v(e)
var i=!0
return"date"!==r&&"any"!==r||void 0===e.weekday&&void 0===e.year&&void 0===e.month&&void 0===e.day||(i=!1),"time"!==r&&"any"!==r||void 0===e.hour&&void 0===e.minute&&void 0===e.second||(i=!1),!i||"date"!==t&&"all"!==t||(e.year=e.month=e.day="numeric"),!i||"time"!==t&&"all"!==t||(e.hour=e.minute=e.second="numeric"),e}function Oe(){var e=null!==this&&"object"===l.typeof(this)&&E(this)
...
if(void 0===e["[[boundFormat]]"]){var r=w.call((function(){var e=arguments.length<=0||void 0===arguments[0]?void 0:arguments[0],r=void 0===e?Date.now():F(e)
return Se(this,r)}),this)
e["[[boundFormat]]"]=r}return e["[[boundFormat]]"]}function Fe(e,r){if(!isFinite(r))throw new RangeError("Invalid valid date passed to format")
...
if(De.hasOwnProperty(O)){var F=t["[["+O+"]]"],S=u["[["+O+"]]"]
if("year"===O&&S<=0?S=1-S:"month"===O?S++:"hour"===O&&!0===t["[[hour12]]"]&&0===(S%=12)&&!0===t["[[hourNo0]]"]&&(S=12),"numeric"===F)w=ae(l,S)
else if("2-digit"===F)(w=ae(c,S)).length>2&&(w=w.slice(-2))
else if(F in we)switch(O){case"month":w=xe(y,b,"months",F,u["[["+O+"]]"])
break
case"weekday":try{w=xe(y,b,"days",F,u["[["+O+"]]"])}catch(E){throw new Error("Could not find weekday data for locale "+s)}break
case"timeZoneName":w=""
break
case"era":try{w=xe(y,b,"eras",F,u["[["+O+"]]"])}catch(E){throw new Error("Could not find era data for locale "+s)}break
default:w=u["[["+O+"]]"]}p.call(f,{type:O,value:w})}else if("ampm"===O){w=xe(y,b,"dayPeriods",u["[[hour]]"]>11?"pm":"am",null),p.call(f,{type:"dayPeriod",value:w})}else p.call(f,{type:"literal",value:g.substring(v,d+1)})
m=d+1,v=g.indexOf("{",m)}return d<g.length-1&&p.call(f,{type:"literal",value:g.substr(d+1)}),f}function Se(e,r){for(var t=Fe(e,r),n="",a=0;t.length>a;a++){n+=t[a].value}return n}function Ee(e,r){for(var t=Fe(e,r),n=[],a=0;t.length>a;a++){var i=t[a]
n.push({type:i.type,value:i.value})}return n}x.DateTimeFormat={"[[availableLocales]]":[],"[[relevantExtensionKeys]]":["ca","nu"],"[[localeData]]":{}},f(V.DateTimeFormat,"supportedLocalesOf",{configurable:!0,writable:!0,value:w.call((function(e){if(!g.call(this,"[[availableLocales]]"))throw new TypeError("supportedLocalesOf() is not a constructor")
var r=k(),t=arguments[1],n=this["[[availableLocales]]"],a=B(e)
return r(),H(n,a,t)}),x.NumberFormat)}),f(V.DateTimeFormat.prototype,"format",{configurable:!0,get:Oe}),Object.defineProperty(V.DateTimeFormat.prototype,"formatToParts",{enumerable:!1,writable:!0,configurable:!0,value:function(){var e=arguments.length<=0||void 0===arguments[0]?void 0:arguments[0],r=null!==this&&"object"===l.typeof(this)&&E(this)
...
var t=void 0===e?Date.now():F(e)
return Ee(this,t)}}),f(V.DateTimeFormat.prototype,"resolvedOptions",{writable:!0,configurable:!0,value:function(){var e=void 0,r=new z,t=["locale","calendar","numberingSystem","timeZone","hour12","weekday","era","year","month","day","hour","minute","second","timeZoneName"],n=null!==this&&"object"===l.typeof(this)&&E(this)
...
for(var a=0,i=t.length;a<i;a++)g.call(n,e="[["+t[a]+"]]")&&(r[t[a]]={value:n[e],writable:!0,configurable:!0,enumerable:!0})
return v({},r)}})
var Le=V.__localeSensitiveProtos={Number:{},Date:{}}
if(Le.Number.toLocaleString=function(){if("[object Number]"!==Object.prototype.toString.call(this))throw new TypeError("`this` value must be a number for Number.prototype.toLocaleString()")
return ae(new Q(arguments[0],arguments[1]),this)},Le.Date.toLocaleString=function(){if("[object Date]"!==Object.prototype.toString.call(this))throw new TypeError("`this` value must be a Date instance for Date.prototype.toLocaleString()")
var e=+this
if(isNaN(e))return"Invalid Date"
var r=arguments[0],t=arguments[1],n=new je(r,t=ke(t,"any","all"))
return Se(n,e)},Le.Date.toLocaleDateString=function(){if("[object Date]"!==Object.prototype.toString.call(this))throw new TypeError("`this` value must be a Date instance for Date.prototype.toLocaleDateString()")
var e=+this
if(isNaN(e))return"Invalid Date"
var r=arguments[0],t=arguments[1],n=new je(r,t=ke(t,"date","date"))
return Se(n,e)},Le.Date.toLocaleTimeString=function(){if("[object Date]"!==Object.prototype.toString.call(this))throw new TypeError("`this` value must be a Date instance for Date.prototype.toLocaleTimeString()")
var e=+this
if(isNaN(e))return"Invalid Date"
var r=arguments[0],t=arguments[1],n=new je(r,t=ke(t,"time","time"))
return Se(n,e)},f(V,"__applyLocaleSensitivePrototypes",{writable:!0,configurable:!0,value:function(){for(var e in f(Number.prototype,"toLocaleString",{writable:!0,configurable:!0,value:Le.Number.toLocaleString}),f(Date.prototype,"toLocaleString",{writable:!0,configurable:!0,value:Le.Date.toLocaleString}),Le.Date)g.call(Le.Date,e)&&f(Date.prototype,e,{writable:!0,configurable:!0,value:Le.Date[e]})}}),f(V,"__addLocaleData",{value:function(e){if(!q(e.locale))throw new Error("Object passed doesn't identify itself with a valid language tag");(function(e,r){if(!e.number)throw new Error("Object passed doesn't contain locale data for Intl.NumberFormat")
...
void 0===I&&function(e){I=e}(r)})(e,e.locale)}}),f(V,"__disableRegExpRestore",{value:function(){x.disableRegExpRestore=!0}}),"undefined"==typeof Intl)try{window.Intl=V,V.__applyLocaleSensitivePrototypes()}catch(Pe){}return V}))
