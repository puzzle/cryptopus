...
h2. Install System Requirements
...
initialize database and loading database dev seeds: @rake db:setup@
...
3. Run Docker container: <notextile>docker run -it --rm --name cryptopus -p 3000:3000 cryptopus</notextile>
4. Execute rake: docker exec cryptopus rake db:setup
