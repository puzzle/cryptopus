...
`);var be=class extends h{static get styles(){return[u,c`
    ...
    `}};window.customElements.define("pzsh-banner",be);var ye=class extends h{static get styles(){return[u,c`
      ...
      <slot></slot>
    </div>`}};window.customElements.define("pzsh-container",ye);var we=class extends h{static get styles(){return[u,c`
        :host(pzsh-footer) {
      ...
      <slot name="end"></slot>
      <slot></slot>
    `}};window.customElements.define("pzsh-footer",we);var xe=class extends h{static get styles(){return[u,c`
        a {
          display: flex;
          align-items: center;
          font-family: var(--pzsh-font-family);
      ...
      <slot></slot>
    </a>`}};window.customElements.define("pzsh-footer-link",xe);var ze=class extends h{static get styles(){return[u,c`
        :host {
